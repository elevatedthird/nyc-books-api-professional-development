...
class ImageStyleDownloadController extends CoreImageStyleDownloadController {
  ...
  public function lookupSourceImage($image_uri) {
    ...
    $potential_sources = [
      ...
      $path_info['dirname'] . DIRECTORY_SEPARATOR . $path_info['filename'] . '.jpeg',
      $path_info['dirname'] . DIRECTORY_SEPARATOR . $path_info['filename'] . '.jpg',
      $path_info['dirname'] . DIRECTORY_SEPARATOR . $path_info['filename'] . '.png',
    ];
